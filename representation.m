...
%REPRESENTATION Source localization representations: HISTOGRAM of the source
% space from the localization across the EEGs. SCALP MAP with the placements
% of reconstructed sources according to the number (fixed threshold) of the
% times sources were localized across the localization in the EEGs. 
% INTERPOLATION using the scalp map representation with the localized 
% sources  
