...
# Localization
Localization was applied to the preprocessed data in frequency and time domain using SBR and TRAP and RAP MUSIC algorithms. For algorithms description, please refer to the sources (Castanon, 2023) and (). 



Frequency domain localization consisted of 
/
